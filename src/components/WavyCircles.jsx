...
const WavyCircles = ({ color }) => {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none overflow-hidden flex items-center justify-center mix-blend-overlay opacity-60">
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 1165 1166"
                className="w-[120vh] h-[120vh] text-current transition-colors duration-1000"
                style={{ color: color }}
            >
                <path
